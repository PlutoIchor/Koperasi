    ...
    <div class="modal-dialog">
        ...
        <form action={{url('/seragam/add')}} method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="formGroupExampleInput2" class="form-label">Nama Seragam</label> 
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="background-color: #1F4492">Kembali</button>
          <button type="submit" class="btn btn-primary" style="background-color: #1F4492">Tambah Data</button>
        </div>
    </form>
</div>
</div>
...
<div class="modal fade" id="edit-seragam{{ $data->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">EDIT DATA SERAGAM</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
        <form action={{url('/seragam/edit/'. $data->id)}} method="POST" enctype="multipart/form-data">
            ...
            <div class="modal-body">
                <div class="mb-3">
                    <label for="formGroupExampleInput" class="form-label">Nama Seragam</label>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" style="background-color: #1F4492">Kembali</button>
          <button type="submit" class="btn btn-primary" style="background-color: #1F4492">Ubah Data</button>
        </div>
    </form>
</div>
</div>
...
@endforeach
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <td>{{ $data->ukuran }}</td>
            <td>
                <a class="btn shadow btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit-seragam{{ $data->id }}"><i class="fa-regular fa-pen-to-square"></i></a>
                <a class="btn shadow btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete-seragam{{ $data->id }}"><i class="fa-regular fa-trash-can"></i></a>
            </tr>
        </td>
            @endforeach
