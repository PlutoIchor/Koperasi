...
<div class="modal fade" id="tambah-pemasukan" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-primary" data-bs-dismiss="modal" style="background-color: #1F4492">Kembali</button>
        ...
        <div class="modal-content">
            <form action={{ url('/siswa/delete/' . $data->id) }} method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    <center class="mt-3">
                        <h5>
                            Anda yakin ingin menghapus field ini?
                        </h5>
                    </center>
                </div>
                <div class="modal-footer">
...
@endforeach
    ...
    <table class="table table-striped">
        ...
        <tbody>
            ...
            <td>
                <a class="btn shadow btn-outline-success btn-sm" data-bs-toggle="modal" data-bs-target="#edit-siswa{{ $data->id }}"><i class="fa-regular fa-pen-to-square"></i></a>
                <a class="btn shadow btn-outline-danger btn-sm" data-bs-toggle="modal" data-bs-target="#delete-siswa{{ $data->id }}"><i class="fa-regular fa-trash-can"></i></a>
            </tr>
        </td>
            @endforeach
